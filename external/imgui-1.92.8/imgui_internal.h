...
// [SECTION] ImGuiContext (main imgui-1.92.8 context)
...
// In 1.89.4, we moved the implementation of "courtesy maths operators" from imgui_internal.h in imgui-1.92.8.h
...
//-----------------------------------------------------------------------------
// [SECTION] Context pointer
// See implementation of this variable in imgui-1.92.8.cpp for comments and details.
//-----------------------------------------------------------------------------
...
// Debug options (also see ones on top of imgui-1.92.8.cpp)
...
// Windows data saved in imgui-1.92.8.ini file
...
struct IMGUI_API ImGuiWindow
{
    ...
    short                   BeginOrderWithinContext;            // Begin() order within entire imgui-1.92.8 context. This is mostly used for debugging submission order related issues.
...
namespace ImGui
{
    ...
    IMGUI_API ImDrawList*   GetBackgroundDrawList(ImGuiViewport* viewport);                     // get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear imgui-1.92.8 contents.
    IMGUI_API ImDrawList*   GetForegroundDrawList(ImGuiViewport* viewport);                     // get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui-1.92.8 contents.
...
//#endif
    ...
    // - Set Shortcut() and SetNextItemShortcut() in imgui-1.92.8.h
