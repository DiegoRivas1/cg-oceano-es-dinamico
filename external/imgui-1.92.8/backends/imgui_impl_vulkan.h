...
//     - Or uncomment here (not recommended because you'd be modifying imgui-1.92.8 sources!)
...
// Register a textures (VkDescriptorSet for a VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE == ImTextureID)
