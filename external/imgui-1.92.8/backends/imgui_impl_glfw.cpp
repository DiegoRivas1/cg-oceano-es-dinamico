// dear imgui-1.92.8: Platform Backend for GLFW
...
//   (passing install_callbacks=false in ImGui_ImplGlfw_InitXXX functions), set the current dear imgui-1.92.8 context and then call our callbacks.
