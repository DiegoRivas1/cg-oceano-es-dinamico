// dear imgui-1.92.8: Renderer Backend for SDL_Renderer for SDL3
// (Requires: SDL 3.1.8+)
...
//  2025-01-18: Use endian-dependent RGBA32 textures format, to match SDL_Color.
...
void ImGui_ImplSDLRenderer3_UpdateTexture(ImTextureData* tex)
{
    ...
    if (tex->Status == ImTextureStatus_WantCreate)
    {
        ...
        IM_ASSERT(sdl_texture != nullptr && "Backend failed to create textures!");
