// dear imgui-1.92.8: Platform Backend for OSX / Cocoa
...
//  2022-02-07: Inputs: Forward keyDown/keyUp events to OS when unused by dear imgui-1.92.8.
...
//  2019-07-21: Re-added clipboard handlers as they are not enabled by default in core imgui-1.92.8.cpp (reverted 2019-05-18 change).
//  2019-05-28: Inputs: Added mouse cursor shape and visibility support.
//  2019-05-18: Misc: Removed clipboard handlers as they are now supported by core imgui-1.92.8.cpp.
...
bool ImGui_ImplOSX_Init(NSView* view)
{
    ...
    // Note that imgui-1.92.8.cpp also include default OSX clipboard handlers which can be enabled
...
static void ImGui_ImplOSX_UpdateMouseCursor()
{
    ...
    {
        // Hide OS mouse cursor if imgui-1.92.8 is drawing it or if it wants no cursor
