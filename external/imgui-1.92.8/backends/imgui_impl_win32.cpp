// dear imgui-1.92.8: Platform Backend for Windows (standard windows API for 32-bits AND 64-bits applications)
// This needs to be used along with a Renderer (e.g. DirectX11, OpenGL3, Vulkan..)

// Implemented features:
//  [X] Platform: Clipboard support (for Win32 this is actually part of core dear imgui-1.92.8)
...
void    ImGui_ImplWin32_NewFrame()
{
    ...
    // Update OS mouse cursor with the cursor requested by imgui-1.92.8
