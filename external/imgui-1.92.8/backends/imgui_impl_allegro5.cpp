// dear imgui-1.92.8: Renderer + Platform Backend for Allegro 5
...
//  2018-04-18: Misc: Added support for 32-bit vertex indices to avoid conversion at runtime. Added imconfig_allegro5.h to enforce 32-bit indices when included from imgui-1.92.8.h.
...
static void ImGui_ImplAllegro5_SetupRenderState(ImDrawData* draw_data)
{
    ...
    // Our visible imgui-1.92.8 space lies from draw_data->DisplayPos (top left) to draw_data->DisplayPos+data_data->DisplaySize (bottom right).
    {
...
// You can read the io.WantCaptureMouse, io.WantCaptureKeyboard flags to tell if dear imgui-1.92.8 wants to use your inputs.
// - When io.WantCaptureMouse is true, do not dispatch mouse input data to your main application, or clear/overwrite your copy of the mouse data.
// - When io.WantCaptureKeyboard is true, do not dispatch keyboard input data to your main application, or clear/overwrite your copy of the keyboard data.
// Generally you may always pass all inputs to dear imgui-1.92.8, and hide them from your application based on those two flags.
...
static void ImGui_ImplAllegro5_UpdateMouseCursor()
{
    ...
    // Hide OS mouse cursor if imgui-1.92.8 is drawing it
