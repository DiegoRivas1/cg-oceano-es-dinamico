...
//   - Read 'Programmer guide' in imgui-1.92.8.cpp for notes on how to setup Dear ImGui in your codebase.
// Read top of imgui-1.92.8.cpp and imgui-1.92.8.h for many details, documentation, comments, links.
...
//   by imgui-1.92.8.h using the IMGUI_DEFINE_MATH_OPERATORS define. For your own sources file they are optional
...
// In other imgui-1.92.8 sources we can use nicer internal functions from imgui_internal.h (ImMin/ImMax) but not in the demo.
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::Text("dear imgui-1.92.8 says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("See comments in imgui-1.92.8.cpp.");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Enable gamepad controls. Require backend to set io.BackendFlags |= ImGuiBackendFlags_HasGamepad.\n\nRead instructions in imgui-1.92.8.cpp for details.");
            ImGui::CheckboxFlags("io.ConfigFlags: NoMouse",              &io.ConfigFlags, ImGuiConfigFlags_NoMouse);
            ImGui::SameLine(); HelpMarker("Instruct dear imgui-1.92.8 to disable mouse inputs and interactions.");
            ...
            ImGui::SameLine(); HelpMarker("Instruct dear imgui-1.92.8 to disable keyboard inputs and interactions.");
            ...
            ImGui::SameLine(); HelpMarker(
                ...
                "- Always ensure that on programmers seat you have at minimum Asserts or Tooltips enabled when making direct imgui-1.92.8 API call! "
...
static void DemoWindowWidgetsDataTypes()
{
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            "As with every widget in dear imgui-1.92.8, we never modify values unless there is a user interaction.\n"
...
static void DemoWindowWidgetsSelectionAndMultiSelect(ImGuiDemoWindowData* demo_data)
{
    if (ImGui::TreeNode("Selection State & Multi-Select"))
    {
        ...
        ImGui::SameLine();
        ImGui::TextLinkOpenURL("imgui-1.92.8/wiki/Multi-Select", "https://github.com/ocornut/imgui/wiki/Multi-Select");
...
static void DemoWindowWidgetsTextInput()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Multi-line Text Input"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Feature is currently in Beta. Please read comments in imgui-1.92.8.h");
        ...
        if (ImGui::TreeNode("Filtered Text Input"))
        {
            ...
            struct TextFilters
            {
                ...
                {
                    if (data->EventChar < 256 && strchr("imgui-1.92.8", (char)data->EventChar))
                        return 0;
                    return 1;
                }
            };
            ...
            static char buf7[32] = ""; ImGui::InputText("\"imgui-1.92.8\"", buf7, IM_COUNTOF(buf7), ImGuiInputTextFlags_CallbackCharFilter, TextFilters::FilterImGuiLetters); // Use CharFilter callback to disable some characters.
            ImGui::TreePop();
        }
...
static void DemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            ...
            // will close the popup. Note that the visibility state of popups is owned by imgui-1.92.8, so the input value
...
struct MyItem
{
    ...
    // As we don't rely on std:: or other third-party library to compile dear imgui-1.92.8, we only have reliable access to qsort(),
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // types and ImVec2/ImVec4. Dear ImGui defines overloaded operators but they are internal to imgui-1.92.8.cpp and not
