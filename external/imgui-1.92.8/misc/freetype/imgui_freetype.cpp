// dear imgui-1.92.8: FreeType font builder (used as a replacement for the stb_truetype builder)
// (code)
...
//  2019/01/15: added support for imgui-1.92.8 allocators + added FreeType only override function SetAllocatorFunctions().
...
//  2018/02/04: moved to main imgui-1.92.8 repository (away from http://www.github.com/ocornut/imgui_club)
...
//  2017/09/26: fixes for imgui-1.92.8 internal changes.
...
// - The default dear imgui-1.92.8 styles will be impacted by this change (alpha values will need tweaking).
